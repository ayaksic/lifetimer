...
- Screen Time page changes recreate the remote report using an identity derived from the page, query reference date, and lifetime start. This refreshes the report without changing the persisted toggle or requesting authorization again.
