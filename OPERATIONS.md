...
7. Enable the Screen Time overlay, approve access, compare aggregate green screen-on duration with Settings > Screen Time, verify the shorter pages use hourly buckets, confirm page swipes/double taps/long presses still work, and leave July Week 4 visible long enough to confirm the report loads without a thermal warning, freeze, watchdog termination, or report-process restart.
