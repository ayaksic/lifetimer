...
Changing timer pages recreates Apple's remote report with the new page identity and filter. The local enable preference remains on and authorization is not requested again.
